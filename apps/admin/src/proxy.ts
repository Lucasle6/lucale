 ...
 *
 * Aquí importa más que en la tienda. Un XSS en el panel se ejecuta con la
 * sesión de un administrador: puede cambiar precios, vaciar inventario o
 * aprobar reembolsos. La tienda expone un catálogo; esto expone el negocio.
 *
